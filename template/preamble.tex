...
%% set the default header and footers using scrheadings.
%%
\pagestyle{scrheadings}

%doc%
%doc% \subsection{Source code}
%doc% \label{sec:source-code}
%doc%
%doc% This template uses the package \emph{listings} to format source code.
%doc% Source code can then be formatted as described in the \href{http://tug.ctan.org/macros/latex/contrib/listings/listings.pdf}{\texttt{documentation}}.
%doc%
\usepackage{listings} %% package to display source code snippets
...
\definecolor{HeaderColor}{RGB}{\myheadercolor}
\definecolor{FooterColor}{RGB}{\myfootercolor}
\definecolor{CaptionColor}{RGB}{\mycaptioncolor}
